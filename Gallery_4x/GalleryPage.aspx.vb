...
Namespace DotNetNuke.Modules.Gallery
    ...
    Public Class GalleryPageBase
        ...
        Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not modDictionary.ContainsKey(ModuleId) OrElse Not modDictionary(_ModuleId).ModuleName = "DNN_Gallery" Then
                Response.Redirect(AccessDeniedURL(), True)
            End If
            ...
            If GalleryAuthorization.HasViewPermission Then
                ...
                If Not ctlToLoad Is Nothing Then
                    ...
                    If _Ctl.ToLower = "viewer" AndAlso GalleryAuthorization.HasEditPermission Then
                        PageTitle = Localization.GetString("ControlTitle_editor", LocalResourceFile)
                    Else
                        PageTitle = Localization.GetString("ControlTitle_" & _Ctl.ToLower, LocalResourceFile)
                    End If
